...
<body>
 <div class="abcd">
  ...
  <button type="button" class="btn btn-outline-primary" id="myBtn" data-toggle="modal" ">
    Read More
  </button>
 ...
 $con=new mysqli("localhost","root","","sahara_database");
        ...
        $sql = "select des from courses where serial_id=$id";
  ...
  mysqli_close($con);
    ...
    <article>
      ...
      <div class="text">
        ...
        <div class="container">
  <!-- Button to Open the Modal -->
  <button type="button" class="btn btn-outline-primary" id="myBtn1" data-toggle="modal">
    Read More
  </button>
 ...
 $con=new mysqli("localhost","root","","sahara_database");
  ...
  mysqli_close($con);
        ...
        <div class="modal-footer">
          <button type="button" class="btn btn-danger" data-dismiss="modal" style="margin-bottom: -42px;">Close</button>
          <button type="button" class="btn btn-success" style="margin-right: 600px; <a href="contact.html" style="color: #FFFFFF;">Enquire us</button>
        </div> 
      </div>
    </div>
  </div>
    ...
    <article>
      ...
      <div class="text">
        ...
        <div class="container">
  <!-- Button to Open the Modal -->
  <button type="button" class="btn btn-outline-primary" id="myBtn" data-toggle="modal" data-target="#exampleModal">
    Read More
  </button>
...
<div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
 ...
 $con=new mysqli("localhost","root","","sahara_database");
  ...
  mysqli_close($con);
        ...
        <div class="modal-footer">
          <button type="button" class="btn btn-danger" data-dismiss="modal" style="margin-bottom: -42px;">Close</button>
          <button type="button" class="btn btn-success" style="margin-right: 400px;">Enquiry</button>
        </div> 
      </div>
    </div>
  </div>
    ...
    <article>
      ...
      <div class="text">
        ...
        <div class="container">
  <!-- Button to Open the Modal -->
  <button type="button" class="btn btn-outline-primary" id="myBtn" data-toggle="modal" data-target="#exampleModalCenter">
    Read More
  </button>
  ...
  mysqli_close($con);
    ...
    <article>
      ...
      <div class="text">
        ...
        <div class="container">
  <!-- Button to Open the Modal -->
  <button type="button" class="btn btn-outline-primary" id="myBtn" data-toggle="modal" data-target="#exampleModalPopovers">
    Read More
  </button>
