            ...
            <li class="nav-item mr-4">
                <button class="btn mb-2" type="button" data-toggle="modal" data-target="#reply">
                    <a style="color: #000; text-decoration: none;" href="index.html">Logout</a>
                     <li class="nav-item mr-4">
                <button class="btn mb-2" type="button" data-toggle="modal" data-target="#reply" style="margin-left: 15px;">
                    <a style="color: #000; text-decoration: none;margin-top: 5px;" href="http://localhost/SAHARA-few/SAHARA/courses.php">Edit courses</a>
                </button>
            </li>
        </ul>
    </div>
